...
const char OK4G[] PROGMEM = "OK";
const char ERROR4G[] PROGMEM = "ERROR";
...
const char SET_CMEE[] PROGMEM = "AT+CMEE=0\r\n";
...
const char RESP_NWSCANSEQ[] PROGMEM = "+QCFG: \"nwscanseq\",010302";
const char SET_QCFG_NWSCANSEQ[] PROGMEM = "AT+QCFG=\"nwscanseq\",010302,1\r\n";

const char GET_NWSCANMODE[] PROGMEM = "AT+QCFG=\"nwscanmode\"\r\n";
const char RESP_NWSCANMODE[] PROGMEM = "+QCFG: \"nwscanmode\",1";
const char SET_QCFG_NWSCANMODE[] PROGMEM = "AT+QCFG=\"nwscanmode\",1,1\r\n";
...
const char RESP_CREGROAMING[] PROGMEM = "+CREG: 2,5";
...
const char RESP_CGREGCREGROAMING[] PROGMEM = "+CGREG: 2,5";
...
const char RESP_CEREGROAMING[] PROGMEM = "+CEREG: 2,5";
...
const char SET_QICSGP[] PROGMEM = "AT+QICSGP=1,1,\"%s\",\"\%s\",\"\%s\",0\r\n";
...
const char SET_MQTTWILL[] PROGMEM = "AT+QMTCFG=\"will\",%d,1,0,0,\"%s\",\"%s\"\r\n";
const char SET_MQTTVERSION[] PROGMEM = "AT+QMTCFG=\"version\",3\r\n";
const char SET_MQTTPDP[] PROGMEM = "AT+QMTCFG=\"pdpcid\",1\r\n";
const char SET_MQTTRECV[] PROGMEM = "AT+QMTCFG=\"recv/mode\",%d,1,1\r\n";
const char SET_MQTTTIMEOUT[] PROGMEM = "AT+QMTCFG=\"timeout\",%d,30,3,0\r\n";
...
const char SET_UNSUBSCRIBE[] PROGMEM = "AT+QMTUNS=%d,1,\"%s\"\r\n";
const char RESP_SUBSCRIBE[] PROGMEM = "+QMTSUB: %d,%d,0,1";
const char RESP_UNSUBSCRIBE[] PROGMEM = "+QMTUNS: %d,1,0";
